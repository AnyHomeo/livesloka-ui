exports.services = {
	prod: {
		...
		Teacher:
			"/teacher?params=id,TeacherDesc,TeacherName,TeacherStatus,_id,category,teacherMail,Salary_tillNow,Commission_Amount_One,Commission_Amount_Many,Bank_account,Phone_number,Bank_full_name,isDemoIncludedInSalaries,leaveDifferenceHours,teacherImageLink,demoPriority,subject,isNotAvailableInBooking,teacherVideoLink",
