			...
			>
				...
				<List>
					{[
						...
						{title: "Add Teacher Details", link: "/teacherDetails"},
						{title: "Reset Password", link: "/reset/password"},
					].map((navItem, index) => (
						<Link style={{textDecoration: "none", color: "black"}} key={index} to={navItem.link}>
				...
				<List>
					{[
						{title: "Generate Invoice", link: "/manual-invoice"},
						{title: "Invoices", link: "/invoices"},
					].map((navItem, index) => (
						<Link key={index} style={{textDecoration: "none", color: "black"}} to={navItem.link}>
							<ListItem button key={navItem.link}>
								<ListItemText primary={navItem.title} />
							</ListItem>
						</Link>
