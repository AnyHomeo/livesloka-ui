...
function SingleRow({ setDialogOpen, todayData, time, day, prevTime, selectedSlot, setDialogData, leaves }) {
	return (
		<div
				...
				<>
					...
					!singleData.slots[day.toLowerCase()].includes(prevTime) ? (
						...
						>
							...
							<div className="students" style={{ marginLeft: 3, marginBottom: 10, cursor: 'pointer' }}>
