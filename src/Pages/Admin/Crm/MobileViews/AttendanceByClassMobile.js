				...
				<AccordionDetails>
					<div>
						<div className={classes.flexContainer}>
							...
							{data.customers.length === 0 && <p className={classes.noStudent}>No students</p>}
							{data.customers.map((student) => (
								<Chip
									...
									label={
										student.firstName ? student.firstName : student.email ? student.email : "Noname"
									}
									size="small"
								/>
							))}
						...
						<div className={classes.flexContainer}>
							...
							{data.absentees.length === 0 && <p className={classes.noStudent}>No students</p>}
