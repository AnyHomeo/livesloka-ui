...
const AddNewCustomer = () => {
	...
	const [customersEditData, setCustomersEditData] = useState({
		...
		isJoinButtonEnabledByAdmin: state ? state?.data?.isJoinButtonEnabledByAdmin : "",
		...
		isJoinButtonEnabledByAdmin: state ? state?.data?.isJoinButtonEnabledByAdmin : "",
		agentId: "",
		teacherName: state ? state?.data?.teacherName : "",
	...
	return (
		<>
			...
			>
				<div className={classes.divCon} style={{display: "flex", alignItems: "center"}}>
				...
				<div className={classes.divCon}>
					<FormControl variant="outlined" style={{minWidth: "100%"}}>
						<InputLabel id="demo-simple-select-filled-label">Class Status:</InputLabel>
						<Select
							label="Class Status"
							fullWidth
							variant="outlined"
				...
				<div className={classes.divCon}>
					<FormControl variant="outlined" style={{minWidth: "100%"}}>
						<InputLabel id="demo-simple-select-filled-label">Class Name:</InputLabel>
						<Select
							label="Class Name"
							name="classId"
							fullWidth
				...
				<div className={classes.divCon}>
					<FormControl variant="outlined" style={{minWidth: "100%"}}>
						...
						>
							{agentDropdown &&
								agentDropdown.map((data) => <MenuItem value={data.id}>{data.AgentName}</MenuItem>)}
						</Select>
					</FormControl>
				</div>
